...
contract TestMarketCreation is Script {
    // Deployed contract addresses (Updated October 29, 2025)
    address constant MARKET_FACTORY = 0x9Be256DDB94Cd1563738c9c77Fca3c62e7321A5E;
    address constant MOCK_USDT = 0x065b8ADad86048edC320277e92C58a4EEB3Bf902;
    ...
    function run() external {
        ...
        MarketFactory.CreateMarketParams memory params = MarketFactory.CreateMarketParams({
            ...
            delphAIMarketId: delphAIMarketId
        });
