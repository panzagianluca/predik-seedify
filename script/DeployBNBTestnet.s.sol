...
contract DeployBNBTestnet is Script {
    ...
    function run() public {
        ...
        // HIGH-4 FIX: Grant FEE_REPORTER_ROLE to Factory (not full admin)
        ...
        console.log("  Factory can now report fees to Treasury (but NOT withdraw)");
        
        // AUDIT FIX: Grant FEE_WITHDRAWER_ROLE to deployer (protocol multisig)
        ...
        console.log("  Deployer can withdraw protocol/creator/oracle fees from Treasury");

        // ===== SECURITY: RENOUNCE FACTORY ADMIN ROLE (CRITICAL-3 FIX) =====
        // NOTE: Commented out for hackathon - requires Factory contract to call renounceRole on itself
        // For production, add this to a post-deployment script callable by Factory
        // console.log("\n==============================================");
        // console.log("SECURITY HARDENING");
        // console.log("==============================================");
        // 
        // console.log("\n[SECURITY] Renouncing Factory admin role on Outcome1155...");
        // console.log("  WHY: Prevents Factory from minting infinite shares");
        // console.log("  RISK: Without this, compromised Factory could drain all markets");
        // outcome1155.renounceRole(adminRole, address(factory));
        // console.log("  [OK] Factory can NO LONGER grant itself MINTER_ROLE");
        // console.log("  [OK] Factory can ONLY create markets (via existing permissions)");
        // console.log("  [OK] Admin control transferred to deployer multisig only");
        ...
        console.log(
            ...
            address(outcome1155),
            "contracts/Outcome1155.sol:Outcome1155 --chain-id 97 --constructor-args $(cast abi-encode \"constructor(string)\" \"https://predik.ar/api/tokens/{id}.json\")"
        );
        ...
        console.log(
            "forge verify-contract", address(factory), "contracts/MarketFactory.sol:MarketFactory --chain-id 97"
        );
        console.log("==============================================\n");
    }
}
