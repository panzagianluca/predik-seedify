...
contract Router is ReentrancyGuard, AccessControl, IERC1155Receiver {
    ...
    function buyWithPermit(
        ...
        // AUDIT FIX: Execute the buy with slippage protection (pass maxCost to market)
        ...
        returns (uint256 netPayout)
    {
        ...
        // AUDIT FIX: Execute the sell with slippage protection (pass minPayout to market)
        netPayout = market.sell(outcome, shareDelta, minPayout);
