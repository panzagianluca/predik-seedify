...
contract LMSRMarketTest is Test {
    ...
    function testPreviewBuyMatchesExecution() public {
        ...
        vm.prank(trader);
        uint256 paid = market.buy(TARGET_OUTCOME, SHARE_DELTA, 0); // 0 = no slippage check
    ...
    function testSellReturnsNetPayout() public {
        ...
        vm.prank(trader);
        market.buy(TARGET_OUTCOME, SHARE_DELTA, 0);
        ...
        vm.prank(trader);
        uint256 netReceived = market.sell(TARGET_OUTCOME, SHARE_DELTA, 0);
    ...
    function testSellMoreThanOwnedReverts() public {
        ...
        vm.prank(trader);
        market.sell(TARGET_OUTCOME, excess, 0);
    }
    ...
    function testTradingPausedBlocksBuysAndSells() public {
        ...
        vm.expectRevert(LMSRMarket.LMSR_TradingPaused.selector);
        vm.prank(trader);
        market.sell(TARGET_OUTCOME, SHARE_DELTA, 0);
    }
